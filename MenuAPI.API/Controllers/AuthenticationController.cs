...
namespace MenuAPI.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
        ...
        [HttpPost("login")]
        public async Task<ActionResult<UserLoginResponseDTO>> Login(UserLoginViewModel userLoginViewModel)
        {
        ...
        public async Task<ActionResult<UserLoginResponseDTO>> RefreshLogin()
        {
